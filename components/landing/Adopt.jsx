...
const Adopt = () => {
    return (
        <div className=" bg-red-600 rounded-2xl flex flex-col md:flex-row items-center h-screen justify-center md:justify-between gap-5 px-5 md:px-10 py-10 md:py-16" style={{ backgroundImage: "url('/images/dalmatian-spots.svg')" }}>
