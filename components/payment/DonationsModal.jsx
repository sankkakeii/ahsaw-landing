...
//             <div className="bg-white rounded-lg p-8 w-11/12 md:w-1/2 z-30">
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white rounded-lg p-8 w-11/12 md:w-1/2">
                ...
                <div className="mt-4">
                    <h2 className="text-xl font-bold text-slate-800 mb-4">Single Donations</h2>
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-bold text-slate-800 mb-4">Monthly Donations</h2>
                    <div className="grid grid-cols-2 gap-4">
                        <div className="flex items-center justify-center gap-2 bg-blue-500 text-white px-4 py-3 rounded-md hover:bg-blue-400">
                            <button className="flex items-center justify-center gap-2">
                                $5
                            </button>
                        </div>
                        <div className="flex items-center justify-center gap-2 bg-indigo-500 text-white px-4 py-3 rounded-md hover:bg-indigo-400">
                            <button className="flex items-center justify-center gap-2">
                                $10
                            </button>
                        </div>
                        <div className="flex items-center justify-center gap-2 bg-yellow-500 text-white px-4 py-3 rounded-md hover:bg-yellow-400">
                            <button className="flex items-center justify-center gap-2">
                                $20
                            </button>
                        </div>
                        <div className="flex items-center justify-center gap-2 bg-green-500 text-white px-4 py-3 rounded-md hover:bg-green-400">
                            <button className="flex items-center justify-center gap-2">
                                $50
                            </button>
                        </div>
                    ...
                    <div className="mt-4">
                        <Link href="/subscribe">
                            <div className="bg-gray-800 text-white px-4 py-2 rounded-md hover:bg-gray-700">
                                Subscribe
                            </div>
                        </Link>
                    </div>
